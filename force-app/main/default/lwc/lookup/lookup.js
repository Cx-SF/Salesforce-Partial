...
export default class Lookup extends LightningElement {
    ...
    processSelectionUpdate(isUserInteraction) {
        ...
        if (isUserInteraction) {
            const selectedIds = this._curSelection.map((sel) => sel);
            const selected = {'selectedId' : selectedIds, 'selectedRow' : this._rowNumber};
            this.dispatchEvent(new CustomEvent('selectionchange', { detail: selected }));
        }
    }
    ...
    handelInputClick(event) {
        ...
        // console.log('handel input click: ' + selected);
    }
